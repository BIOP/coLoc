...
**The Scientist** will pick up cards to define the microscope they'll be using for their acquisition.
Available microscopy cards 
...
| <img src="https://github.com/BIOP/coloc/blob/main/resources/cards/1-Microscopy_cards_SR-recto.png" title="SuperRes" width="25%" align="center">  | ... | ... |
| ... | ... | ... |
| ... | ... | ... |
| ... | ... | ... |
...
We offer 3 different versions of the game, each with a different price and content.
- **Standard** version: the full game, with 3 decks of **The Scientists** cards, 1 deck of **Reviewer 3** cards, 6 decks of **The Experiment** cards, 1 dice and 4 boxes.
- **Light** version: a more compact version, with only the essential cards (no boxes, nor dice). Ideal if you want to save on shipping!
